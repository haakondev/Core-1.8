...
public class GamemodeCreativeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!sender.hasPermission("core.gmc") && !sender.hasPermission("core.gamemodes")){
            noperm(sender);
            return true;
        }
        ...
        if (p == null) {
            ...
            sender.sendMessage(prefix + tc("&cYou set " + p.getDisplayName() + "'s gamemode to &c&lCREATIVE"));
        }

        p.sendMessage(prefix + tc("Your gamemode has been set to &c&lCREATIVE"));
