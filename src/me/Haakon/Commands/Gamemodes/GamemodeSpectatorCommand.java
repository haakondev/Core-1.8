...
public class GamemodeSpectatorCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (!sender.hasPermission("core.gmsp") && !sender.hasPermission("core.gamemodes")){
            noperm(sender);
            return true;
        }
        ...
        if (p == null) {
            ...
            sender.sendMessage(prefix + tc("&cYou set " + p.getDisplayName() + "'s gamemode to &c&lSPECTATOR"));
        }

        p.sendMessage(prefix + tc("Your gamemode has been set to &c&lSPECTATOR"));
